    ...
    return (
        <Form {...form}>
            <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
                <GeneratedAvatar seed={form.watch("name")} variant="bottsNeutal" className="border size-16" />
                ...
                <FormField name="instructions" control={form.control} render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input {...field} placeholder="you are a helpful assistant that can answer questions and helpful with assignments" />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                )} />
