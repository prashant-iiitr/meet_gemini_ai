  ...
  export const CallEnded = () => {
      ...
      return (
        <div className="flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,rgba(83,116,108,0.18),rgba(8,10,12,1))] px-4 py-8">
